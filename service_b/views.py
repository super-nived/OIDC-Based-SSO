...
@login_required
def home(request):
    user_profile = UserProfileB.objects.get(username=request.user.username)
...
def callback(request):
    ...
    user_profile, created = UserProfileB.objects.get_or_create(username=decoded_id_token.get('sub'))

    # Redirect to the home page
    return HttpResponseRedirect('/service_b/')
